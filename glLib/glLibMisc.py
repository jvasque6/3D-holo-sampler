...
def glLibSaveScreenshot(path,rect=GLLIB_AUTO,type=GLLIB_RGB,framebuffer=0,overwrite=True, resolution = [800,600]):
    surface = glLibScreenSurf(rect,type,framebuffer)
    surface = pygame.transform.scale(surface, (resolution[0], resolution[1]))
